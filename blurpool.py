...
class BlurPool2D(Layer):
    ...
    def __init__(self, kernel_size=5, stride=2, **kwargs):
        ...
        if self.kernel_size==1:     self.a = [1,]
        elif self.kernel_size==2:   self.a = [1, 1]
        elif self.kernel_size==3:   self.a = [1, 2, 1]
        elif self.kernel_size==4:   self.a = [1, 3, 3, 1]
        elif self.kernel_size==5:   self.a = [1, 4, 6, 4, 1]
        elif self.kernel_size==6:   self.a = [1, 5, 10, 10, 5, 1]
        elif self.kernel_size==7:   self.a = [1, 6, 15, 20, 15, 6, 1]
